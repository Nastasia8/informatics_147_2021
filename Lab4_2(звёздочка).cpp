...
int main()
{
    setlocale(LC_ALL, "");
    const int X = 8, Y = 8;
    float x_arr[X]{ -4.3, -4, -3.8, -3.1, -2.1, -0.8, -0.5, 0.4 };
    float y_arr[Y]{ 4.018, 4.025, 4.035, 4.048, 4.012, 4.028, 4.015, 4.002 };
    ...
    // Вычисляем значение линейной ф-ии и находим невязку
    cout << "   y line " << endl;
    double y_lin[Y]{};
