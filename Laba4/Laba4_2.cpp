...
int main()
{
    ...
    double linb = (XiYi * Xi - Xi_2 * Yi) / (Xi * Xi - Xi_2 * length);
    ...
    cout << endl;
    cout << endl << "Аппроксимировали экспериментальные данные линейной зависимостью y = " << lina << "x + " << linb << " c невязкой Q = " << linQ << "  и квадратичной зависимостью y = " << a << "x^2 + " << b << "x " << c << "  c  невязкой Q = " << Q_2 << endl;
    return 0;
}